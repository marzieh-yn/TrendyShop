        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrnetPrice = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraDetailes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    Created_Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThreeItems = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProTypes_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wish_List_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Wish_List_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_AddressId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderHeader_User_Address_User_AddressId",
                        column: x => x.User_AddressId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProCatSub", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProCatSub_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProCatSub_Sub_Category_Sub_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ProductSizesId = table.Column<int>(type: "int", nullable: true),
                    ProductColorsId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCart_ProductColors_ProductColorsId",
                        column: x => x.ProductColorsId,
                        principalTable: "ProductColors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShoppingCart_ProductSizes_ProductSizesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_ProductColors_ProductColorsId",
                        column: x => x.ProductColorsId,
                        principalTable: "ProductColors",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_ProductColorsId",
                table: "OrderDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeader_User_AddressId",
                table: "OrderHeader",
                column: "User_AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_ProCatSub_ProductId",
                table: "ProCatSub",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProCatSub_Sub_CategoryId",
                table: "ProCatSub",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCart_ProductColorsId",
                table: "ShoppingCart",
                column: "ProductColorsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCart_ProductSizesId",
                table: "ShoppingCart",
                column: "ProductSizesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wish_List_ProductId",
                table: "Wish_List",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Wish_List_UserId",
                table: "Wish_List",
                column: "UserId");
        }
