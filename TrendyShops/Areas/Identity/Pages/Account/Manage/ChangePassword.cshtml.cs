...
namespace TrendyShops.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        private readonly Helper _service;

        public ChangePasswordModel(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            ILogger<ChangePasswordModel> logger, IUnitOfWork unitOfWork, Helper service)
        {
            _service = service;
